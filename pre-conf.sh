...
/usr/bin/mysqld_safe &
 ...
 tar -zxvf drupal-8.0.0-beta1.tar.gz
 rm drupal-8.0.0-beta1.tar.gz
 mv drupal-8.0.0-beta1/* drupal-8.0.0-beta1/.htaccess /var/www
 rmdir -R drupal-8.0.0-beta1.tar.gz
